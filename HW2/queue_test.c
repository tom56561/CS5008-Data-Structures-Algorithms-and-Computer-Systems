...
int unitTest8(int status){
    ...
    //Check data[0] is not be overwrited by new data.
    if(testq->data[0] == 1){
        passed = 1;
    }else{
	    free_queue(testq);
...
//Test queue_peek method work well
...
//Test queue_back method work well
